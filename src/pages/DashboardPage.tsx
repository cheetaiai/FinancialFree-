...
export const DashboardPage: React.FC<DashboardPageProps> = ({
  ...
  return (
    <div className="space-y-4 sm:space-y-6 pb-28 md:pb-24">
      ...
      <div className="p-3.5 sm:p-4 rounded-2xl bg-gradient-to-r from-emerald-600 via-emerald-700 to-teal-700 text-white shadow-lg shadow-emerald-600/20 flex flex-col sm:flex-row sm:items-center justify-between gap-3 border border-emerald-400/30">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl bg-white/20 backdrop-blur-md flex items-center justify-center font-black text-sm flex-shrink-0 border border-white/20">
            APK
          </div>
          <div>
            <div className="flex items-center gap-2 flex-wrap">
              <span className="font-bold text-sm sm:text-base">Download FinancialFree Android App (.apk)</span>
              <span className="px-2 py-0.5 rounded-full text-[10px] font-mono font-bold bg-white/20 text-white">160 KB</span>
            </div>
            <p className="text-xs text-emerald-100 mt-0.5">
              Instant 1-tap direct download for Samsung, Pixel, OnePlus, and all Android devices.
            </p>
          </div>
        </div>
        ...
        <button
          ...
          className="px-4 py-2.5 rounded-xl bg-white text-emerald-800 hover:bg-emerald-50 font-bold text-xs sm:text-sm flex items-center justify-center gap-2 shadow-md cursor-pointer transition-all active:scale-95 flex-shrink-0"
        >
          <Download size={16} />
