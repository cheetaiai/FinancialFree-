    ...
    <div className="space-y-6 pb-24">
      ...
      <div>
        ...
        <p className="text-xs sm:text-sm text-slate-500 dark:text-slate-400 mt-0.5">
          Manage currency formatting, user profile & phone, data synchronization, and security.
        </p>
      </div>

      {/* USER PROFILE & PHONE FEATURE CARD */}
      <UserProfileCard />
      ...
      <LiquidGlassCard variant="primary" className="space-y-4">
        ...
        {isAdmin ? (
          ...
          <div className="p-3.5 rounded-2xl liquid-glass-secondary border border-slate-200/60 dark:border-white/10 flex items-center justify-between gap-3 text-xs">
            <div className="flex items-center gap-2.5">
              <div className="w-8 h-8 rounded-xl bg-blue-500/10 text-blue-500 flex items-center justify-center font-bold">
                <UserCheck size={16} />
              </div>
              <div>
                <div className="font-bold text-slate-900 dark:text-white">Personal Account Storage</div>
                <div className="text-[11px] text-slate-500">Your lending records, borrowers, and reminders are isolated and private to your single account.</div>
              </div>
            </div>
            <span className="text-[10px] font-bold px-2.5 py-1 rounded-full bg-emerald-500/10 text-emerald-600 border border-emerald-500/20 whitespace-nowrap">
        ...
        <div className="flex items-center justify-between flex-wrap gap-3">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            <LiquidButton
              ...
              size="sm"
              onClick={() => {
                showToast('Downloading FinancialFree.apk...', 'info');
                const ok = downloadApkClientSide();
                if (ok) {
                  showToast('FinancialFree.apk downloaded successfully!', 'success');
                } else {
