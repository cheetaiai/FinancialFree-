      ...
      >
        <LiquidGlassCard variant="floating" className="p-7 sm:p-9 border border-white/80 dark:border-white/10 shadow-2xl">
          ...
          <div className="flex flex-col items-center text-center mb-8">
            ...
            <div className="mt-3 inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-blue-500/10 text-blue-600 dark:text-blue-400 text-xs font-semibold border border-blue-500/20">
              <ShieldCheck size={14} />
