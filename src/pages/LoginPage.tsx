      ...
      >
        ...
        <LiquidGlassCard variant="floating" className="p-7 sm:p-9 border border-white/80 dark:border-white/10 shadow-2xl">
          ...
          <button
            ...
            className="w-full py-3.5 px-4 rounded-2xl bg-white dark:bg-slate-800/95 text-slate-800 dark:text-white font-semibold text-sm border border-slate-200/90 dark:border-white/10 shadow-md hover:shadow-lg hover:bg-slate-50 dark:hover:bg-slate-700/80 transition-all flex items-center justify-center gap-3 cursor-pointer disabled:opacity-50 active:scale-[0.98] group"
          >
