        ...
        >
                ...
                <div className="flex items-center gap-4 py-1">
                  ...
                  <div className="flex-1 text-xs space-y-1.5 pl-2 text-slate-600 dark:text-slate-300">
                    <div className="flex items-start gap-1.5 font-medium">
                      ...
                      <span>Tap the <strong>"Install App"</strong> button below or Chrome menu (⋮).</span>
                    </div>
                    <div className="flex items-start gap-1.5 font-medium">
                    ...
                    <div className="flex items-start gap-1.5 font-medium">
                      ...
                      <span>Icon appears on your launcher with full standalone app performance.</span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="mt-5 flex items-center justify-end gap-2.5">
            ...
            {isInstalled ? (
              ...
              >
                <Download size={16} />
                <span>{isInstalling ? 'Opening Installer...' : 'Install on This Device'}</span>
              </button>
            )}
          </div>
        </motion.div>
